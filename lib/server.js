...
function updateCategory(req, res) {
  ...
  result = { id, name, display_name, description };
...
function deleteCategory(req, res) {
  ...
  let holdDB = db_categories;
  db_categories= [];
  holdDB.forEach(item =>{
    if(item !== null){
      db_categories.push(item);
    }
  });
...
function updateProducts(req, res) {
  ...
  result = { id, category, name, display_name, description };
